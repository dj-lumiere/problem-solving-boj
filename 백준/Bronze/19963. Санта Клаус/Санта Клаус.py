...
with open(0, 'r') as f:
    ...
    for hh in range(1, t + 1):
        ...
        first_bag = {int(input()) for _ in range(m)}
        second_bag = {int(input()) for _ in range(k)}
        all_kids = set(range(1, n + 1))
        third_bag = all_kids - (first_bag | second_bag)
        answer = f"{len(third_bag)}\n" + " ".join(map(str, third_bag))
