...
def is_lucky(
    available_operations: list[tuple[tuple[str, int], tuple[str, int]]]
) -> bool:
    available_mods: list[bool] = [False, True, False, False, False, False, False]
    for (op1, v1), (op2, v2) in available_operations:
        available_mods_sub: list[bool] = [
            False,
            False,
            False,
            False,
