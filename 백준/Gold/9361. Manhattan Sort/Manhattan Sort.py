...
with open(0, 'r') as f:
    ...
    for hh in range(1, t + 1):
        ...
        current_index = {v: i for i, v in enumerate(grid)}
        sorted_index = {v: i for i, v in enumerate(sorted(grid))}
        answer = sum(abs(current_index[i] - sorted_index[i]) for i in grid) // 2
